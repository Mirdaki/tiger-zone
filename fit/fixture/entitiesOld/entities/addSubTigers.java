...
public class addSubTigers {
	...
	private Player tester = new Player(51);
	private CrocodileObject croc = new CrocodileObject(0,'n',tester,0);
	...
	private LakeTerrain testTerrain = new LakeTerrain(list, croc);
